const KHQR = BakongKHQR
    ...
    document.getElementById("merc-name").innerHTML = `${merchantName}`
    document.getElementById("total-amount-khqr").innerHTML = `${formatAmount(transactionAmount, currencyCode)}`
    document.getElementById("currency").innerHTML = `${currencyCode}`
    document.getElementById("currency-sign").innerHTML = getCurrencySign(currencyCode)

    function formatAmount(amount = 0, currencyCode) {
