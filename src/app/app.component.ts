...
export class AppComponent implements OnInit {
  ...
  constructor(private renderer: Renderer2, private el: ElementRef) {
    this.qrData = "your QR code data here";
  ...
  ngOnInit(): void {
    ...
    const { merchantName, transactionAmount, transactionCurrency } = decodeResult.data;
    ...
    this.renderer.setProperty(this.el.nativeElement.querySelector("#currency"), 'innerHTML', transactionCurrency);
    this.renderer.setProperty(this.el.nativeElement.querySelector("#currency-sign"), 'innerHTML', this.getCurrencySign(transactionCurrency));
  }
